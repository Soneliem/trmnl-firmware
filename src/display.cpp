...
#include "FastEPD.h"
FASTEPD bbep;
// FastEPD targets mono panels and doesn't define these color constants.
// Provide fallbacks so the BWR/BWYR helpers still compile (they are unused on mono).
#ifndef BBEP_RED
#define BBEP_RED 3
#endif
#ifndef BBEP_YELLOW
...
/* 8 */  1, 1, 1, 1, 2, 2, 1, 2, 1,
/* 9 */  1, 1, 1, 1, 1, 1, 2, 2, 1,
/* 10 */ 2, 2, 1, 1, 1, 1, 2, 2, 1,
/* 11 */ 2, 2, 2, 1, 1, 1, 2, 2, 1,
/* 12 */ 1, 1, 1, 1, 1, 2, 2, 2, 1,
/* 13 */ 2, 1, 1, 1, 1, 2, 2, 2, 1,
/* 14 */ 2, 2, 2, 2, 2, 1, 2, 2, 1,
...
#else
    bbep.initPanel(BB_PANEL_EPDIY_V7); //, 26000000);
    bbep.setPanelSize(1600, 1200, 0, -2280);
#endif
...
#else
    (void)enabled; // FastEPD doesn't expose a light-sleep toggle
#endif
}
